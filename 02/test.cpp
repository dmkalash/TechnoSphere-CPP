...
/*
 * просто создание
 * просто установка старт колбек
 * просто установка энд колбек
 * просто установка digit
 * просто установка string
 *
 * tp с дефолтным колбеком и норм текстом(пробелы, пропуски, строки, числа)
 * tp с установленными колбеками, меняющими данные(всеми 4)
 * tp с пустым текстом
 * tp только с пробелами
 * tp только с числами
 * tp только со строками
 *
 * tp с передачей лямбды
 * tp с передачей указателя на функцию
 * tp с std::function
 * */
